...
const K9_ITEMS: Record<Locale, K9Item[]> = {
  pl: [
    {
      title: "Quiz filmowy",
      body: "Sprawdź, ile zapamiętałeś z wycieczki! Ukończ quiz i zgarnij zniżkę na gadżety.",
      image: "/galeria/Sciezka_filmowa/webp/1.webp",
    },
    {
      title: "Sztuczna inteligencja",
      body: "Wejdź w interaktywną rozmowę i odkryj tajemnice planu filmowego i świata przyszłości.",
      image: "/galeria/Sciezka_filmowa/webp/2.webp",
    },
    {
      title: "Kosmobudka zdjęć",
      body: "Stań w scenerii jak z science-fiction i zrób pamiątkowe zdjęcie z wyprawy po Alvernia Planet.",
      image: "/galeria/Sciezka_filmowa/webp/3.webp",
    },
    {
      title: "Wrota wymiarów",
      body: "Przekrocz granicę rzeczywistości i zajrzyj do niezwykłych światów dzięki interaktywnym wrotom multimedialnym.",
      image: "/galeria/Sciezka_filmowa/webp/4.webp",
    },
    {
      title: "Lewitujące kamienie",
      body: "To nie magia — to technologia! Uchwyć wyjątkowy moment obok lewitujących kamieni.",
  ...
  en: [
    {
      title: "Film quiz",
      body: "Check how much you remember from the tour! Finish the quiz and grab a discount on merch.",
      image: "/galeria/Sciezka_filmowa/webp/1.webp",
    },
    {
      title: "Artificial intelligence",
      body: "Enter an interactive chat and uncover secrets of the film set and the world of tomorrow.",
      image: "/galeria/Sciezka_filmowa/webp/2.webp",
    },
    {
      title: "Cosmo photo booth",
      body: "Step into a sci-fi scenery and take a souvenir photo from your Alvernia Planet trip.",
      image: "/galeria/Sciezka_filmowa/webp/3.webp",
    },
    {
      title: "Portals to other dimensions",
      body: "Cross the edge of reality and peek into remarkable worlds through interactive multimedia portals.",
      image: "/galeria/Sciezka_filmowa/webp/4.webp",
    },
    {
      title: "Levitating stones",
      body: "Not magic—technology! Capture a unique moment beside levitating stones.",
      image: "/galeria/Sciezka_filmowa/webp/5.webp",
    },
  ],
};
