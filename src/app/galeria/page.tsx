...
const CAPTIONS: Record<Locale, { general: string[]; film: string[]; events: string[]; exhibitions: string[] }> = {
  pl: {
    ...
    exhibitions: [
      "Wejście do wystawy z logo",
      "Główna sala z artefaktami",
      "Stroje bohaterów podświetlone",
      "Stanowisko z różdżkami",
      "Eksponaty quidditcha",
      "Interaktywne ekrany zaklęć",
      "Gabloty z rekwizytami filmowymi",
      "Strefa doświadczeń multisensorycznych",
    ],
  },
  en: {
    general: [
    ...
    exhibitions: [
      "Exhibition entry with logo",
      "Main hall of artifacts",
      "Hero costumes under lights",
      "Wand display station",
      "Quidditch artifacts",
      "Interactive spell screens",
      "Film prop showcases",
      "Multisensory experience zone",
    ],
  },
};
